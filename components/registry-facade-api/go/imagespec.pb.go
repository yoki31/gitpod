...
type EnvVarApplication int32

const (
	EnvVarApplication_SET_IF_NOT_EXISTS EnvVarApplication = 0
	EnvVarApplication_OVERWRITE         EnvVarApplication = 1
	EnvVarApplication_APPEND            EnvVarApplication = 2
	EnvVarApplication_PREPEND           EnvVarApplication = 3
)

// Enum value maps for EnvVarApplication.
var (
	EnvVarApplication_name = map[int32]string{
		0: "SET_IF_NOT_EXISTS",
		1: "OVERWRITE",
		2: "APPEND",
		3: "PREPEND",
	}
	EnvVarApplication_value = map[string]int32{
		"SET_IF_NOT_EXISTS": 0,
		"OVERWRITE":         1,
		"APPEND":            2,
		"PREPEND":           3,
...
func (x EnvVarApplication) Enum() *EnvVarApplication {
	p := new(EnvVarApplication)
	*p = x
	return p
}

func (x EnvVarApplication) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EnvVarApplication) Descriptor() protoreflect.EnumDescriptor {
	return file_imagespec_proto_enumTypes[0].Descriptor()
}

func (EnvVarApplication) Type() protoreflect.EnumType {
	return &file_imagespec_proto_enumTypes[0]
}

func (x EnvVarApplication) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use EnvVarApplication.Descriptor instead.
func (EnvVarApplication) EnumDescriptor() ([]byte, []int) {
...
type ImageSpec struct {
	...
	// environment_variable adds env vars to the image
	EnvironmentVariable []*EnvironmentVariable `protobuf:"bytes,4,rep,name=environment_variable,json=environmentVariable,proto3" json:"environment_variable,omitempty"`
	// entrypoint command of the container
...
func (x *ImageSpec) GetEnvironmentVariable() []*EnvironmentVariable {
	if x != nil {
...
// EnvironmentVariable is an env var we ought to apply.
type EnvironmentVariable struct {
	...
	Mode  EnvVarApplication `protobuf:"varint,3,opt,name=mode,proto3,enum=registryfacade.EnvVarApplication" json:"mode,omitempty"`
}

func (x *EnvironmentVariable) Reset() {
	*x = EnvironmentVariable{}
	if protoimpl.UnsafeEnabled {
		mi := &file_imagespec_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EnvironmentVariable) Descriptor() ([]byte, []int) {
	return file_imagespec_proto_rawDescGZIP(), []int{4}
}
...
func (x *EnvironmentVariable) GetMode() EnvVarApplication {
	if x != nil {
		return x.Mode
	}
	return EnvVarApplication_SET_IF_NOT_EXISTS
}
...
var file_imagespec_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_imagespec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_imagespec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_imagespec_proto_goTypes = []interface{}{
	(EnvVarApplication)(0),      // 0: registryfacade.EnvVarApplication
	(*ImageSpec)(nil),           // 1: registryfacade.ImageSpec
	(*ContentLayer)(nil),        // 2: registryfacade.ContentLayer
	(*RemoteContentLayer)(nil),  // 3: registryfacade.RemoteContentLayer
	(*DirectContentLayer)(nil),  // 4: registryfacade.DirectContentLayer
	(*EnvironmentVariable)(nil), // 5: registryfacade.EnvironmentVariable
}
var file_imagespec_proto_depIdxs = []int32{
	2, // 0: registryfacade.ImageSpec.content_layer:type_name -> registryfacade.ContentLayer
	5, // 1: registryfacade.ImageSpec.environment_variable:type_name -> registryfacade.EnvironmentVariable
	3, // 2: registryfacade.ContentLayer.remote:type_name -> registryfacade.RemoteContentLayer
	4, // 3: registryfacade.ContentLayer.direct:type_name -> registryfacade.DirectContentLayer
	0, // 4: registryfacade.EnvironmentVariable.mode:type_name -> registryfacade.EnvVarApplication
...
func file_imagespec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_imagespec_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_imagespec_proto_enumTypes,
